...
class VillagerListCell: UITableViewCell {
    ...
    // iniciando a célula, adicionando as subviews de imagem e nome do villager e adicionando as constraints
    ...
    // definindo a cor do fundo da célula e a borda
    ...
    // adicionando constraints da célula
    ...
    // ao scrollar, seta a imagem e o nome do villager pra zero a fim de reutilizar a célula ja carregada, deixando a navegacao mais fluida
